...
print(f'The loan_costs list contains a total of {len(loan_costs)} loans')

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans

print(f'The sum total of all the loans in loan_costs is ${sum(loan_costs)}')
...
print(f'The average price of a loan in loan_costs is ${average_loan_price: .2f}')
...
print(f'A fair value for this loan is ${fair_value: .2f}')
...
if fair_value >= 500:
    print('Buy this loan! Our fair value calculation shows that it is worth more than the current cost')
else:
    print('Do no buy this loan, it is too expensive, and not worth the current price')
...
present_value = present_value_function(1000, 12, 0.2)
